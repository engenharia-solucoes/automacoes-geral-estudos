...
try:
    nome_arquivo_json = sentinel.generateJsonToCallAPI(limit=1000)

    sentinel.convertJsonToNdjson(nome_arquivo_json, "MVthreatsNDJson.json")
    ...
    es.send_json_to_elk(file_name="MVthreatsNDJson.json", index_name="mv-sentinel-threat-teste", tipo_envio="threat", nome_cliente="MV")
